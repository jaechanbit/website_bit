import { NavItem, PagePath, Course } from './types';
...
export const NAVIGATION: NavItem[] = [
  { label: '학원소개', path: PagePath.ABOUT },
  {
    label: '교육과정',
    children: [
      { label: '국민내일배움카드 과정', path: PagePath.COURSE_NATIONAL },
      { label: '초·중·고 교육과정', path: PagePath.COURSE_STUDENT },
    ],
  },
  {
    label: '시험센터',
    children: [
      { label: 'ITQ 시험센터', path: PagePath.CENTER_ITQ },
      { label: 'DIAT 시험센터', path: PagePath.CENTER_DIAT },
    ],
  },
  { label: '수강후기·성과', path: PagePath.REVIEWS },
  { label: '공지사항', path: PagePath.NOTICES },
];
