...
import { NATIONAL_COURSES } from '@/lib/constants';
import { Info } from 'lucide-react';

export default function NationalCoursePage() {
  return (
    <div className="flex flex-col">
      <div className="bg-brand-navy text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">국민내일배움카드 과정</h1>
          <p className="text-blue-100 text-lg max-w-2xl mx-auto">국비지원을 통해 부담 없이 전문 기술을 습득하세요.</p>
        </div>
      </div>
